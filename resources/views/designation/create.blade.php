                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-2">
                        <form id="editDesignationForm" class="space-y-6"> {{-- space-y-6 for form spacing --}}
                            ...
                            <div class="grid md:grid-cols-[1fr_4fr] md:gap-4 border border-gray-300 rounded-md"> {{-- Grid and border styles from branch modal --}}
                                ...
                                <div class="md:border-l md:border-gray-300">
                                    <input type="text" id="edit_designation_name" name="name"
                                           class="shadow-sm py-3 px-3 block w-full sm:text-sm text-black placeholder-black border-none md:rounded-r-md rounded-md bg-white focus:outline-none" autocomplete="off" onpaste="return false;"> {{-- Input Styles & Restrictions - consistent with branch modal --}}
                                </div>
                            </div>
                        </form>
                    </div>
